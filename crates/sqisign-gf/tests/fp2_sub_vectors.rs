//! Differential test of the ported `fp2_sub` against the committed
//! C-derived vectors. Binary shape: (a_re, a_im, b_re, b_im) ->
//! (c_re, c_im). Componentwise `fp_sub` on both halves.

use sqisign_gf::{fp2_sub, Fp, Fp2, NWORDS_FIELD};
use sqisign_vectors::{decode, load};

const VECTORS: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../vectors/gf/fp2_sub.json");
