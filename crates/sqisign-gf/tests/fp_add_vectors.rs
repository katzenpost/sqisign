//! Differential test of the ported `fp_add` against the committed
...
//! reference's `modadd` leaves in memory, including its unmasked limb 4.

use sqisign_gf::{fp_add, Fp, NWORDS_FIELD};
use sqisign_vectors::{decode, load};

const VECTORS: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../vectors/gf/fp_add.json");
