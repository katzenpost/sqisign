//! Differential test of the ported `fp_sub` against the committed
...
//! reference's `modsub` leaves in memory, including its unmasked limb 4.

use sqisign_gf::{fp_sub, Fp, NWORDS_FIELD};
use sqisign_vectors::{decode, load};

const VECTORS: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../vectors/gf/fp_sub.json");
