//! Differential test of `weil`. Inputs: e (u32), P, Q, PQ (ec_points),
//! curve (mutated). Outputs: pairing value (fp2), mutated curve.
mod common;
...
const VECTORS: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../vectors/ec/weil.json");

#[test]
fn weil_matches_reference_vectors() {
    let file = load(VECTORS).expect("vector file must load");
    assert_eq!(file.boundary, "sqisign_ec::weil");
